...
//--------------------------------------------------------------------------
#include "PeopleEventBumpServiceOutEventTestHandler.hh"

bool PeopleEventBumpServiceOutEventTestHandler::testEvent(
	...
	std::cout << "Bump Person Event! Found: " << s.getObject_idCopy()[0] << "\n";
